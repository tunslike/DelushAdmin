...
?>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
								...
								<!--begin::Title-->
									...
									<!--begin::Item-->
										<li class="breadcrumb-item text-muted">
											<a href="index.html" class="text-muted text-hover-primary">Orders</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Manage Order</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
					...
					<h3 class="fw-bold my-2 welcomeTxt">Manage Order</h3>
   ...
   <div class="card-header border-0 pt-6">
      ...
      <div class="card-title">
         ...
         <div class="d-flex align-items-center position-relative my-1">
			...
			<input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Orders">
         </div>
         <!--end::Search-->
      </div>
      <!--begin::Card title-->
                     ...
                     <td>
                        ...
                        <?php 
                            switch($order->ORDER_STATUS) {
                                ...
                                break;
                                case 1:
                                    echo '<div class="badge badge-light-success">Available</div>';
                                break;
                                case 2:
                                    echo '<div class="badge badge-light-danger">Out of stock</div>';
                                break;
                            }
                        ?>
