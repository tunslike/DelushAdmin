...
?>
							...
							<div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-900">User Management</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
   ...
   ?>
					...
					<h3 class="fw-bold my-2 welcomeTxt">Manage Users</h3>
   ...
   <div class="card-header border-0 pt-6">
      ...
      <div class="card-title">
         ...
         <div class="d-flex align-items-center position-relative my-1">
			...
			<input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Users">
         </div>
         <!--end::Search-->
      </div>
      <!--begin::Card title-->
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_subscriptions_table">
               <thead>
                  <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
				    ...
				    <th style="width: 80px;">Status</th>
                     ...
                     <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 188.375px;">Phone</th>
                     <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 188.375px;">Email</th>
					 <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table" rowspan="1" colspan="1" aria-label="Billing: activate to sort column ascending" style="width: 201.297px;">Role</th>
					 ...
					 <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table" rowspan="1" colspan="1" aria-label="Billing: activate to sort column ascending" style="width: 201.297px;">First Login</th>
					 <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table" rowspan="1" colspan="1" aria-label="Billing: activate to sort column ascending" style="width: 201.297px;">Logged In</th>
               ...
               <?php foreach($data['users'] as $user): ?>
                ...
                <tr class="odd">
                     ...
                     <td>
                        ...
                        <?php 
                            switch($user->STATUS) {
                                ...
                                break;
                                case 1:
                                    echo '<div class="badge badge-light-success">Disabled</div>';
                                break;
                                case 2:
                                    echo '<div class="badge badge-light-danger">Invalid</div>';
                                break;
                            }
                        ?>
                     ...
                     <td>
                        <div class="badge badge-light"><?php echo $user->FIRST_NAME.' '.$user->LAST_NAME; ?></div>
                     </td>
            
                     <td>
                            <span class="badge badge-light"><?php echo $user->PHONE_NUMBER; ?></span>              
                     </td>
					 <td>
					 <span class="badge badge-light"><?php echo $user->EMAIL_ADDRESS; ?></span>                
                     </td>
					 ...
					 <?php 
                            switch($user->ROLE_ID) {
                                case '001':
                                    echo '<div class="badge badge-light-primary">Manager</div>';
                                break;
                                case '002':
                                    echo '<div class="badge badge-light-primary">Operator</div>';
                                break;
								case '003':
                                    echo '<div class="badge badge-light-primary">Guest</div>';
                                break;
                            }
                        ?>
                     </td>
					 <td>
                        <span class="badge badge-light"><?php echo formatEventDate($user->DATE_CREATED); ?></span>  
                     </td>
					 <td>
                        <span class="badge badge-light"><?php echo formatEventDate($user->FIRST_LOGIN_DATE); ?></span>  
                     </td>
					 <td>
							
					 <?php 
                            switch($user->IS_LOGGED) {
                                case 0:
                                    echo '<div class="badge badge-light-danger">No</div>';
                                break;
                                case 1:
                                    echo '<div class="badge badge-light-success">Yes</div>';
                                break;
                            }
                        ?>
                     ...
                     <td class="text-end">
                        <a href="#" class="btn btn-primary btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                        Manage</a>
                     </td>
                  </tr>
